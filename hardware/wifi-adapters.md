...
Included antenna works ok but is quite big and heavy. It is suggested to replace it with proper 5-5.9ghz antenna in long range setups 

* [product example](https://zsecurity.org/product/realtek-rtl8812au-2-4-5-ghz-usb-wireless-adapter) 
* [alternative example](https://de.aliexpress.com/item/32664378094.html)
